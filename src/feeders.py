...
class Feeder(Dataset):
    ...
    def __init__(self, data_path, instructions_path, instructions_level=[3],  sample_frame=100, bin=256, img_size=256, data_size=None):
    ...
    def __getitem__(self, index):
        ...
        for frame in sample['trajectory'][:-1]: 
            # each frame
            
            imgs.append(frame['img']) # numpy array
            sensors=sample['trajectory'][0]['state']['sensors']
